                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">646-717-1044</span>
                            <a href="tel:646-717-1044" className="contact__button">Call me
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">@doyoun_g</span>
                            <a href="https://www.instagram.com/doyoun_g/" className="contact__button">Messenger
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
                    </div>
